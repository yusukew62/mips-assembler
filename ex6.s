...
# 関数
MUL: addi $sp, $sp, -4 # スタックの領域を確保
sw $ra, 0($sp) # 戻りアドレスをスタックポインタにストア
...
skip: addu $17, $17, $17 # 被乗数レジスタを1ビット左シフト
addu $16, $16, $16 # maskを1ビット左シフト
addi $11, $11, 1 # cnt++
j loop
...
addi $13, $13, 4 # Aを進める
addi $14, $14, 16 # Bを進める
lw $ra, 0($sp) # スタックポインタを読み込む
jr $ra # レジスタの値をアドレスとしてジャンプ
#関数終了
